...
def measure_train_validation_test(
    ...
    shutil.copy(train_labels_B_path + '.txt', folder_path_PC)
    shutil.copy(train_labels_B_path + '.key', folder_path_PC)
    ...
    shutil.copy(test_labels_B_path+".txt", folder_path_PC)
    shutil.copy(test_labels_B_path+".key", folder_path_PC)
    time.sleep(1)  # wait for the folder to be empty again when files are moved!
